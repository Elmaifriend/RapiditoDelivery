                ...
                @if ($isHeadingToRestaurant)
                    ...
                    >
                        ...
                        <x-ui.card class="bg-gray-50/50">
                            <p class="mb-3 text-center text-[10px] font-bold uppercase tracking-wider text-gray-400">Desliza
                                            ...
                                            <span class="flex items-center gap-2 text-xs font-semibold text-gray-800">
                                                <i
                                                    ...
                                                    :class="checkedItems[{{ $index }}] ?
                                                        'bx-check-square text-emerald-500' : 'bx-checkbox text-gray-400'"
                                                ></i>
                                                <span>
                                                    <strong
                ...
                @else
                    ...
                    >
                        ...
                        <x-ui.card>
                            ...
                            <div class="mb-3">
                                <p class="text-[10px] font-bold uppercase tracking-wider text-gray-400">Tienda de origen
                                </p>
                                <p class="mt-0.5 text-sm font-bold text-gray-900">{{ $restaurant->name ?? 'Restaurante' }}
                                </p>
                            </div>
                    ...
                    >
                        <x-ui.card>
                            ...
                            <div class="space-y-2">
                                <label class="text-[10px] font-bold uppercase tracking-wider text-gray-400">Resultado de la
                                    entrega</label>
                            ...
                            @if ($paymentOutcome !== 'paid_correctly')
                                <div
                                    ...
                                    x-transition
                                >
                                    <label class="text-[10px] font-bold uppercase tracking-wider text-amber-600">Detalle de
                                        la incidencia</label>
                                    <textarea
                                        class="w-full resize-none rounded-2xl border border-gray-200 bg-gray-50 p-3 text-xs font-semibold text-gray-800 placeholder-gray-400 transition-all focus:border-red-500 focus:bg-white focus:outline-none focus:ring-4 focus:ring-red-500/10"
                                        wire:model="driverNotes"
