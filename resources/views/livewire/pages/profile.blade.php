...
@section('content')
    ...
    <x-ui.page-section title="Opciones">
        <div
            class="flex cursor-pointer select-none items-center gap-4 rounded-2xl bg-white p-4 transition-transform active:scale-90">
